...
namespace CTTSite.MockData
{
    public class MockDataConsultation
    {
        ...
        public static List<Consultation> consultationsList = new List<Consultation>()
        {
            ...
            new Consultation(4, DateTime.Now.Date.AddDays(1), new TimeSpan(16, 0, 0), new TimeSpan(17, 0, 0), 1, " ", " ", " ", false),
            new Consultation(5, DateTime.Now.Date.AddDays(1), new TimeSpan(18, 0, 0), new TimeSpan(19, 0, 0), 1, " ", " ", " ", false)
        };
